...
== Structure
= helpers
In this folder is the Ruby file with all the needed functions.<br />
= templates
Here are all the templates. For example the one (deck.haml) with the default settings, stylesheets and scripts, which is used in the deck function.<br />
= slides
Here you have to save all your slides. Of course you can create subfolders. This folder will be accessed by the funciton slides.<br />
= public
This folder contains the deck.js plugin and you should save all your .html files in this folder.<br />
== Usage
